const CACHE='trophy-tracker-v3';
const CORE=['./','./index.html','./styles.css','./challenge-library.css','./app.js','./species-icons.js','./challenge-library.js','./manifest.webmanifest','./icon.svg'];
