const CACHE='trophy-tracker-v5';
const CORE=['./','./index.html','./styles.css','./challenge-library.css','./app.js','./species-icons.js','./waterfowl-icons-compat.js','./challenge-library.js','./challenge-data-fixes.js','./manifest.webmanifest','./icon.svg'];
