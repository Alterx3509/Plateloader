const CACHE='trophy-tracker-v4';
const CORE=['./','./index.html','./styles.css','./challenge-library.css','./app.js','./species-icons.js','./waterfowl-icons-compat.js','./challenge-library.js','./manifest.webmanifest','./icon.svg'];
